 ...
 * This file demonstrates how to integrate Waveshard with a web frontend
 */

// For React/Vue/Angular applications
export class WaveshardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WaveshardClient(provider, contractAddress);
